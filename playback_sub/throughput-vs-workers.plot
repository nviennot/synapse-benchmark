...
plot 'throughput-vs-workers.dat' using 1:5 title "1000 users" with linespoint lt 1 ps 1 lw 3 lc 1 pt 1, \
     ''                          using 1:4 title "100 users"  with linespoint lt 1 ps 1 lw 3 lc 3 pt 6, \
     ''                          using 1:3 title "10 users"   with linespoint lt 1 ps 1 lw 3 lc 4 pt 2, \
     ''                          using 1:2 title "1 users"    with linespoint lt 1 ps 1 lw 3 lc 2 pt 4, \
