...
#set format y "%.0e"
set ylabel "Publisher overhead [ms] (log)" font "Times-Roman,14"
...
set ytics (1,3,4,5,7,10,15,20,30,50,70,100,200,300,1000,3000)
...
plot 'overhead-vs-deps.dat' using 1:6 title "MySQL"       with linespoint lt 1 ps 1 lw 4 lc 4 pt 2, \
